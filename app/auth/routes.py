...
from app.auth.email_auth_utils import send_password_reset_email
...
def register():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.login'))
    return render_template('auth/register.pug', title=_('Register'), form=form)
...
def reset_password_request():
    ...
    return render_template(
        'auth/reset_password_request.pug',
